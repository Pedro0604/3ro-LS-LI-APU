...
public class VoorheesExporter {
	...
	private String exportar(Socio socio) {
		...
		return "\t{" + separator + "\t\t\"nombre\": \"" + socio.getNombre() + "\"," + separator + "\t\t\"email\": \""
				+ socio.getEmail() + "\"," + separator + "\t\t\"legajo\": \"" + socio.getLegajo() + "\"" + separator
				+ "\t}";
	}
	...
	public String exportar(List<Socio> socios) {
		...
		socios.forEach(socio -> {
			buffer.append(this.exportar(socio)).append(",").append(separator);
		});
