...
public class WallPostUI {
	...
	private void wireComponents() {
		this.like.addActionListener(e -> {
			Logger.getLogger("UI").log(Level.INFO, "Like!");
			this.wallPost.like();
			this.likesLabel.setText(String.valueOf(this.wallPost.getLikes()));
		});

		this.dislike.addActionListener(e -> {
			Logger.getLogger("UI").log(Level.INFO, "Dislike!");
			this.wallPost.dislike();
			this.likesLabel.setText(String.valueOf(this.wallPost.getLikes()));
		});

		this.featuredCheckbox.addActionListener(e -> {
			if (this.wallPost.isFeatured()) {
				Logger.getLogger("UI").log(Level.INFO, "Unfeatured!");
			} else {
				Logger.getLogger("UI").log(Level.INFO, "Featured!");
			}
		...
		this.textArea.getDocument().addDocumentListener(new DocumentListener() {
			...
			public void removeUpdate(DocumentEvent e) {
				Logger.getLogger("UI").log(Level.INFO, "Texto quitado!");
				wallPost.setText(textArea.getText());
			}

			@Override
			public void insertUpdate(DocumentEvent e) {
				Logger.getLogger("UI").log(Level.INFO, "Texto añadido!");
				wallPost.setText(textArea.getText());
			}

			@Override
			public void changedUpdate(DocumentEvent e) {
				Logger.getLogger("UI").log(Level.INFO, "Texto cambiado!");
				wallPost.setText(textArea.getText());
			}
		});
